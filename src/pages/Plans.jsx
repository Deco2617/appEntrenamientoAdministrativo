...
const Plans = () => {
  ...
  const fetchActiveSubscriptions = async () => {
    try {
      ...
      const activeSubs = response.data?.stats?.activeSubs || 0;
  ...
  return (
    <div className="flex bg-gray-50 min-h-screen">
      ...
      <main className="flex-1 ml-0 lg:ml-64 p-4 lg:p-8 pt-16 lg:pt-8 relative">
        <header className="mb-6 lg:mb-8 flex justify-between items-center">
          <div>
            <h1 className="text-xl lg:text-2xl font-bold text-gray-800">Planes</h1>
                ...
                {plans.map((plan) => (
                  <tr key={plan.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-4 px-4 text-center">
                      <span className={`px-3 py-1 text-xs font-medium rounded-full inline-flex items-center gap-1 ${plan.is_active
              ...
              <div className="bg-[#C2185B] px-6 py-4 flex justify-between items-center">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-pink-100 text-xs font-medium tracking-wide mt-1">
              ...
              <form onSubmit={handleSave} className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="4"
                    className={`w-full px-4 py-2 border rounded-lg focus:ring-2 outline-none resize-none transition-all ${formData.description === DEFAULT_DESCRIPTION_TEXT
